...
// Middleware
app.use(cors({
  origin: ['http://localhost:5173', 'http://localhost:3000','https://admin-abinexis.vercel.app','https://abinexis.vercel.app','https://store.abinexis.com','https://abinexis-backend.vercel.app'],// Allow requests from your frontend
